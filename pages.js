...
/***/ function(module, exports, __webpack_require__) {
	...
	function update_pagelist(pagelist, make_page_icon, current, total, max_show) {
	    ...
	    if (total <= max_show) {
	        ...
	        for (var i = 0; i < total; i++) {
	            var icon = make_page_icon(i, i + '', i == current ? 'current' : undefined);
	            icon.attr('idx', i);
	    ...
	    var beg = current - (max_show / 2 | 0);
	    var end = current + (max_show / 2 | 0) + 1;
	    if (beg < 0) {
	        var r = 0 - beg;
	        beg += r;
	        end += r;
	    ...
	    for (var _i = beg; _i < end; _i++) {
	        ...
	        if (_i == beg && beg != 0) {
	            icon_name = '|<';
	            icon_addr = 0;
	        } else if (_i == end - 1 && end != total) {
	            icon_name = '>|';
	            icon_addr = total - 1;
	        }
	        var _icon = make_page_icon(_i, icon_name, _i == current ? 'current' : undefined);
	        _icon.attr('idx', icon_addr);
	        pagelist.append(_icon);
	    }
	    return pagelist;
	}

	function build_pagelist(show_page, make_page_icon, get_pages_length, icon_max_show) {
	    var pagelist = (0, _jquery2.default)('<div class="pagelist"></div>');
	    var current = 0;
	    pagelist.on(events.update, function (evt) {
	        update_pagelist(pagelist, make_page_icon, current, get_pages_length(), icon_max_show);
	        show_page(current);
	    });
	    pagelist.on(events.goto_page, function (evt, p) {
	        current = Math.max(0, Math.min(get_pages_length() - 1, p));
	        pagelist.trigger(events.update);
	    });
	    pagelist.on('click', function (evt) {
	        var idx = (0, _jquery2.default)(evt.target).attr('idx');
	...
	function init() {
	    var content = (0, _jquery2.default)('.pages>.content');
	    function show_page(p) {
	        content.text('this is page ' + p);
	    }
	    function make_icon(idx, text, current) {
	        var ret = (0, _jquery2.default)('<div class="pages-icon"></div>');
	        ret.text(text);
	        if (current) {
	            ret.addClass('active');
	        }
	    ...
	    (0, _jquery2.default)('.pagelist-box').append(build_pagelist(show_page, make_icon, function () {
	        return 50;
	    }, 5));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./pages.scss", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/sass-loader/index.js!./pages.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".pages-icon {\n  display: inline-block;\n  width: 2em;\n  height: 2em;\n  line-height: 2em;\n  text-align: center;\n  margin: 0.25em;\n  background-color: cornflowerblue;\n  color: lightyellow; }\n  .pages-icon.active {\n    background-color: lightgray;\n    color: darkblue; }\n", ""]);
