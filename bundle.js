...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stars = __webpack_require__(172);
	...
	var PageContent = function (_Component) {
	    ...
	    function PageContent() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PageContent).call(this));

	        _this.state = { score_service: undefined, score_quality: undefined, score_price: undefined };
	        return _this;
	    }

	    _createClass(PageContent, [{
	        key: 'getScoreTotal',
	        value: function getScoreTotal() {
	            var score = [this.state.score_service, this.state.score_quality, this.state.score_price].reduce(function (base, i) {
	                if (i) {
	                    base[0] += i;
	                    base[1] += 1;
	                }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    ' ',
	                    _react2.default.createElement(_stars2.default, { onScoreChange: function onScoreChange(s) {
	                            _this2.setState({ score_service: s });
	                        } })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    ' ',
	                    _react2.default.createElement(_stars2.default, { onScoreChange: function onScoreChange(s) {
	                            _this2.setState({ score_quality: s });
	                        } })
	                ),
	                _react2.default.createElement(
	                    'div',
	                ...
	                _react2.default.createElement(
	                    ...
	                    ' ',
	                    _react2.default.createElement(_stars2.default, { freeze: true, score: this.getScoreTotal() })
	                )
	            );
	        }
	    }]);
	...
	(0, _reactDom.render)(_react2.default.createElement(PageContent, null), document.getElementById('main'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Star = function (_Component) {
	    ...
	    _createClass(Star, [{
	        key: 'clickHandle',
	        value: function clickHandle(evt) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'span',
	                { className: 'stars-star ' + cls, onClick: this.clickHandle.bind(this) },
	                _react2.default.createElement('span', { className: 'stars-star stars-star-cover', style: this.getValue() })
	            );
	        }
	    }]);
	...
	var Stars = function (_Component2) {
	    _inherits(Stars, _Component2);

	    function Stars() {
	        _classCallCheck(this, Stars);

	        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Stars).call(this));

	        var score = _this2.props && _this2.props.score || 0;
	        _this2.state = { stars_count: 5, stars_score: score };
	        return _this2;
	    }

	    _createClass(Stars, [{
	        key: 'clieckStarHandle',
	        value: function clieckStarHandle(idx) {
	            if (!this.props.freeze) {
	                var score = (idx + 1.0) / this.state.stars_count;
	        ...
	        key: 'getStarValue',
	        value: function getStarValue(idx) {
	            var score = this.props && this.props.score || this.state.stars_score;
	            var value_sum = score * this.state.stars_count;
	            if (value_sum >= idx + 1) {
	                return 1;
	            } else if (value_sum > idx) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'span',
	                { className: 'stars' },
	                Array(this.state.stars_count).fill(0).map(function (_, idx) {
	                    return _react2.default.createElement(Star, { key: idx, idx: idx,
	                        active: _this3.getStarValue(idx) == 0 ? 0 : 1,
	                        value: _this3.getStarValue(idx),
	                        onClickStar: _this3.clieckStarHandle.bind(_this3) });
	                })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./stars.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./stars.css");
